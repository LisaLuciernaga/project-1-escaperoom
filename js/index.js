...
window.addEventListener("load", function(){
    ...
    const notClickableImg = [frames, painting, wardrobe, comode] // Creating an array to iterate over inside the hover event listener to display text -> should we just create all non-clickable images in the array from the start?
